...
def args_parser():
    ...
    parser.add_argument('--num_users', type=int, default=600,
    ...
    parser.add_argument('--cr', type=float, default=1/8,
                        help="compress rate of pilot signals")
    ...
    # model arguments
    parser.add_argument('--model', type=str, default='SWT', help='model name')
    parser.add_argument('--snr', type=int, default=20, help='snr')
    # other arguments
    parser.add_argument('--dataset', type=str, default='CDL', help="name \
                        of dataset")
    parser.add_argument('--num_classes', type=int, default=10, help="number \
                        of classes")
    parser.add_argument('--gpu', default=0, help="To use cuda, set \
                        to a specific GPU ID. Default set to use CPU.")
    parser.add_argument('--optimizer', type=str, default='fedams', help="type \
                        of optimizer")
